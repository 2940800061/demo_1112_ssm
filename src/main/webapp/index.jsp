...
<header>
    ...
    <p class="user-info"><i class="glyphicon glyphicon-user"
                            style='${sessionScope.userInfo.accountGender=="男"  ?  "color:orange;" : "color:red;"}'></i>
        ${sessionScope.userInfo.accountName}[${sessionScope.userInfo.TDemoRole.roleName}]</p>
</header>
<aside>
    <ul class="nav nav-pills nav-stacked"
    ">
    <c:forEach var="perm" items="${sessionScope.userInfo.TDemoRole.TDemoPermissions }">
